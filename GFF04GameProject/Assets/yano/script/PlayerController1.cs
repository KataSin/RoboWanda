...
public class PlayerController1 : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        m_State = PlayerState1.StartFall;
    ...
    void Update()
    {
        ...
        if (m_State != PlayerState1.StartFall)
        ...
        m_Animator.SetBool("IsStartFall", m_IsStartFall);
    ...
    void Normal()
    {
        ...
        {
            m_State = PlayerState1.Aiming;
        }

        // Bボタンを押すとしゃがむ
        if (Input.GetButtonDown("Creeping"))
        {
            m_State = PlayerState1.Creeping;
        }
